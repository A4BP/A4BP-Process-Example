...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.0.0(build 090114.0200.2413) AT [THU MAY 07 11:07:19 PDT 2009]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                exclude-result-prefixes="xsi xsl wsdl ns3 tns ns1 ns2 ns4 inp1 ns0 xsd plt ns5 imp1 bpws xpath20 ora socket oraext dvm hwf mhdr med ids xdk xref ldap">
  <xsl:template match="/">
    <imp1:PurchaseOrder>
      <imp1:CustID>
